          ...
          <div className="mx-auto max-w-2xl px-6 py-16 md:py-24">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-black/80 sm:text-lg">
                Fill out the form below to schedule your complimentary intro
                call. We&rsquo;ll go over your goals, lesson details and set up
                a trial lesson to kickstart your musical journey.
              </p>
            </div>
